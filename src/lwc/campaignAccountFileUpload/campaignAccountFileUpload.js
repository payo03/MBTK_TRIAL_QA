 ...
 * @author : Choi Taewook
 * @date : 2024-11-25
 * @description : 캠페인 퀵액션 버튼 account
 * @target : 
==============================================================
...
import accountFileUpload from "@salesforce/apex/CampaignFileUploadController.accountFileUpload";
import { NavigationMixin, CurrentPageReference } from "lightning/navigation";
import { CloseActionScreenEvent } from "lightning/actions";
import { showToast } from "c/commonUtil";

export default class CampaignAccountFileUpload extends NavigationMixin(LightningElement) {
